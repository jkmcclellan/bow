...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<cocoapods-downloader>.freeze, [">= 1.2.0", "< 2.0"])
      ...
      s.add_runtime_dependency(%q<cocoapods-trunk>.freeze, [">= 1.3.0", "< 2.0"])
      s.add_runtime_dependency(%q<cocoapods-try>.freeze, [">= 1.1.0", "< 2.0"])
      s.add_runtime_dependency(%q<molinillo>.freeze, ["~> 0.6.5"])
      s.add_runtime_dependency(%q<xcodeproj>.freeze, [">= 1.5.7", "< 2.0"])
      ...
      s.add_dependency(%q<cocoapods-downloader>.freeze, [">= 1.2.0", "< 2.0"])
      ...
      s.add_dependency(%q<cocoapods-trunk>.freeze, [">= 1.3.0", "< 2.0"])
      s.add_dependency(%q<cocoapods-try>.freeze, [">= 1.1.0", "< 2.0"])
      s.add_dependency(%q<molinillo>.freeze, ["~> 0.6.5"])
      s.add_dependency(%q<xcodeproj>.freeze, [">= 1.5.7", "< 2.0"])
